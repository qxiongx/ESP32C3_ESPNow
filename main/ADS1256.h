...
#define DOUT          gpio_get_level(DOUT_PIN)
#define DIN           gpio_get_level(DIN_PIN)
#define DIN1          gpio_set_level(DIN_PIN, 1)
#define DIN0          gpio_set_level(DIN_PIN, 0)
...
#define CMD_RREG         0x10 //读寄存器
#define CMD_WREG         0x50 //写寄存器
